...
def model_load(prefix='sl',data_dir=None,training=True):
    ...
    models = [f for f in os.listdir(os.path.join(root_path,"models")) if re.search("sl",f)]
    ...
    for model in models:
        ...
        all_models[re.split("-",model)[1]] = joblib.load(os.path.join(root_path,"models",model))
...
def model_predict(country,year,month,day,all_models=None,test=False):
    ...
    update_predict_log(country,y_pred,y_proba,target_date,
                       ...
                       runtime, MODEL_VERSION, test=True)
